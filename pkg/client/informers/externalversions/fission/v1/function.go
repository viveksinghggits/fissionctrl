...
import (
	...
	internalinterfaces "github.com/fissionctrl/pkg/client/informers/externalversions/internalinterfaces"
	v1 "github.com/fissionctrl/pkg/client/listers/fission/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.FissionV1().Functions(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.FissionV1().Functions(namespace).Watch(options)
			},
		},
		&fissionv1.Function{},
		resyncPeriod,
...
func (f *functionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&fissionv1.Function{}, f.defaultInformer)
}
